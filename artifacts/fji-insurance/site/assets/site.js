...
(function () {
  ...
  function init() {
    ...
    // Page-to-page crossfade is handled natively by the cross-document View
    // Transitions API (see `@view-transition` in styles.css). The browser
    // snapshots the old page and crossfades to the new one with no blank/white
    // frame, on mobile and desktop alike, and degrades to an instant navigation
    // on browsers without support. No JS fade-out hack is needed.
